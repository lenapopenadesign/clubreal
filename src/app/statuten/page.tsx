    ...
    <>
      ...
      <section className="bg-background px-6 md:px-20 py-20">
        ...
        <p className="text-lg text-muted leading-relaxed max-w-[700px]">
          ...
          alle Mitglieder. Beschlossen in der Generalversammlung am 11.3.2025.
        </p>
        <Link
          href="/Club Real Vereinsstatuten 2025 (aktuell).pdf"
          target="_blank"
          className="inline-flex items-center justify-center gap-1.5 rounded-full bg-primary text-white px-6 py-3 h-12 text-sm font-medium font-[family-name:var(--font-heading)] mt-6"
        >
          PDF herunterladen
        </Link>
      </section>
        ...
        <div className="max-w-[800px] flex flex-col gap-12">
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              {'(1) Der Verein führt den Namen \u201ECLUB REAL IMMOBILIENSACHVERSTÄNDIGE\u201C.'}
            </p>
            <p className="text-base text-muted leading-relaxed">
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              Der Verein, dessen Tätigkeit nicht auf Gewinn gerichtet ist, bezweckt die Erhaltung und
              Verbesserung der Qualitätsstandards im gesamten Leistungsbild der Immobilientreuhänder
              und Immobiliengutachter und des ethischen Verhaltens im Immobilienwesen in Österreich.
            </p>
          </article>
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              (2) Als ideelle Mittel dienen: Regelmäßige Sitzungen; Veranstaltungen zur Weiterbildung;
              Pflege eines vereinsinternen Qualitätssicherungssystems für Sachverständige;
              Diskussionsrunden und Arbeitskreise; Vorträge von Vereinsmitgliedern und anderen Experten;
              Abhalten von Exkursionen; Publikationen.
            </p>
            <p className="text-base text-muted leading-relaxed">
              (3) Die erforderlichen materiellen Mittel sollen aufgebracht werden durch:
              Beitrittsgebühren und Mitgliedsbeiträge; Erträgnisse (aus Veranstaltungen, Publikationen etc.);
              Spenden, Vermächtnisse und Sammlungen.
            </p>
          </article>
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              Geldmittel – fördern. Ehrenmitglieder sind Personen, die wegen besonderer Verdienste um
              den Verein zu solchen ernannt werden.
            </p>
          </article>
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              (1) Ordentliche Mitglieder des Vereins können alle physischen Personen werden, die sich zu
              den Zielen des Vereines bekennen. Der Vorstand ist berechtigt, nähere Bestimmungen für
              Bewerbung, Anwärterstatus und Beitritt zu erlassen.
            </p>
            <p className="text-base text-muted leading-relaxed">
              (2) Über die Aufnahme von ordentlichen und außerordentlichen Mitgliedern entscheidet der
              Vorstand nach Erörterung in einer Sitzung endgültig. Der Beschluss muss einstimmig
              erfolgen – die Ablehnung auch nur eines Vorstandsmitglieds verhindert die Aufnahme. Die
              Ablehnung der Aufnahme bedarf keiner Begründung.
            </p>
            <p className="text-base text-muted leading-relaxed">
              (3) Außerordentliche Mitglieder haben ein Fragerecht an den Vorstand und das Recht, bei der
              Generalversammlung oder zur Tagesordnung Anträge einzubringen.
            </p>
            <p className="text-base text-muted leading-relaxed">
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              (3) Der Vorstand kann ein Mitglied ausschließen, wenn dieses trotz schriftlicher Mahnung
              unter Setzung einer 14-tägigen Nachfrist länger als sechs Monate ab Vorschreibung mit
              der Zahlung der Mitgliedsbeiträge im Rückstand ist.
            </p>
            <p className="text-base text-muted leading-relaxed">
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              und das Wahlrecht stehen nur den ordentlichen und den Ehrenmitgliedern zu.
            </p>
            <p className="text-base text-muted leading-relaxed">
            ...
            <p className="text-base text-muted leading-relaxed">
              (7) Die Mitglieder sind verpflichtet, sich aktiv am Vereinsleben zu beteiligen. Dazu gehört die
              Teilnahme an den regelmäßigen Sitzungen, Beiträge zur Fortbildung und die Bereitschaft
              zu fachlichen Auskünften.
            </p>
          </article>
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              (2) Eine außerordentliche Generalversammlung findet auf Beschluss des Vorstands oder der
              ordentlichen Generalversammlung, schriftlichen Antrag von mindestens einem Zehntel der
              Mitglieder, Verlangen der Rechnungsprüfer oder Beschluss eines gerichtlich bestellten
              Kurators binnen vier Wochen statt.
            </p>
            <p className="text-base text-muted leading-relaxed">
              (3) Sowohl zu den ordentlichen wie auch zu den außerordentlichen Generalversammlungen
              sind alle Mitglieder mindestens zwei Wochen vor dem Termin schriftlich oder per E-Mail
              einzuladen.
            </p>
            <p className="text-base text-muted leading-relaxed">
            ...
            <p className="text-base text-muted leading-relaxed">
              (7) Die Generalversammlung ist ohne Rücksicht auf die Anzahl der erschienenen Personen
              beschlussfähig.
            </p>
            <p className="text-base text-muted leading-relaxed">
              ...
              das Statut des Vereins geändert oder der Verein aufgelöst werden soll, bedürfen einer
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              Rechnungsabschlusses; Wahl und Enthebung der Mitglieder des Vorstands und der
              Rechnungsprüfer; Genehmigung von Rechtsgeschäften zwischen Rechnungsprüfern und
              Verein; Entlastung des Vorstands; Festsetzung der Höhe der Beitrittsgebühr und der
              Mitgliedsbeiträge; Verleihung und Aberkennung der Ehrenmitgliedschaft; Beschlussfassung
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              (1) Der Vorstand besteht aus drei bis sechs Mitgliedern, und zwar aus Obmann/Obfrau
              allenfalls Stellvertreter/in, Schriftführer/in allenfalls Stellvertreter/in sowie Kassier/in
              allenfalls Stellvertreter/in.
            </p>
            <p className="text-base text-muted leading-relaxed">
              (2) Der Vorstand wird von der Generalversammlung gewählt.
            </p>
            <p className="text-base text-muted leading-relaxed">
              (3) Die Funktionsperiode eines Vorstandsmitglieds beträgt vier Jahre, eine Wiederwahl ist –
              auch mehrmals – möglich. Jede Funktion im Vorstand ist persönlich auszuüben.
            </p>
            <p className="text-base text-muted leading-relaxed">
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              fallen insbesondere: Einrichtung eines Rechnungswesens; Erstellung des Jahresvoranschlags,
              des Rechenschaftsberichts und des Rechnungsabschlusses; Vorbereitung und Einberufung
              der Generalversammlung; Information der Vereinsmitglieder; Verwaltung des
              Vereinsvermögens; Aufnahme und Ausschluss von Vereinsmitgliedern; Aufnahme und
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              Vertretungshandlungen oder Erklärungen des Vereins bedürfen zu ihrer Gültigkeit der
              Unterschriften des Obmanns/der Obfrau und eines weiteren Vorstandsmitglieds.
            </p>
            <p className="text-base text-muted leading-relaxed">
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              von vier Jahren gewählt. Eine Wiederwahl ist möglich. Die Rechnungsprüfer dürfen keinem
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              bestem Wissen und Gewissen. Seine Entscheidungen sind vereinsintern endgültig und für
              die Vereinsorgane bindend.
            </p>
          </article>
          ...
          <article className="flex flex-col gap-4">
            ...
            <p className="text-base text-muted leading-relaxed">
              ...
              Abwicklung zu beschließen. Bei Auflösung des Vereines ist das verbleibende Vereinsvermögen
              für gemeinnützige oder mildtätige Zwecke im Sinne der §§ 34 ff der Bundesabgabeordnung
              BAO zu verwenden.
            </p>
          </article>

          <p className="text-sm text-muted italic">
            Vorgelegt in der Vorstandssitzung am 11.2.2025. Beschlossen in der Generalversammlung am 11.3.2025.
          </p>
        </div>
      </section>
    </>
