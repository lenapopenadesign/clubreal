...
export default function KontaktForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col gap-3 p-7 bg-white shadow-sm rounded-2xl">
  ...
  return (
    <form
      ...
      className="flex flex-col gap-5 p-7 bg-white shadow-sm rounded-2xl"
    >
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="phone" className="text-sm font-medium text-foreground">
          Telefonnummer <span className="text-muted font-normal">(optional)</span>
        </label>
        <input
          type="tel"
          id="phone"
      ...
      <div className="flex flex-col gap-3">
        <span className="text-sm font-medium text-foreground">
          Spezialisierungen <span className="text-muted font-normal">(optional)</span>
        </span>
        ...
        <input type="hidden" name="specializations" value={selected.join(", ")} />
      </div>
